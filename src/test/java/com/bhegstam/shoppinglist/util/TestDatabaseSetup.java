...
public class TestDatabaseSetup implements TestRule {
    ...
    private void insertUsers() {
        ...
        workspaceRepository.add(TestData.ADMIN.getId(), TestData.ADMIN_DEFAULT_WORKSPACE);
        workspaceRepository.add(TestData.USER.getId(), TestData.USER_DEFAULT_WORKSPACE);
        workspaceRepository.add(TestData.UNVERIFIED_USER.getId(), TestData.UNVERIFIED_USER_DEFAULT_WORKSPACE);
    }
