...
public class TestData {
    ...
    public static final Workspace ADMIN_DEFAULT_WORKSPACE = Workspace.create("Default", ADMIN);
    ...
    public static final Workspace USER_DEFAULT_WORKSPACE = Workspace.create("Default", ADMIN);

    public static final User UNVERIFIED_USER = new User("unverified-user", "unverified-user-1", "unverified@user.com", false, Role.USER);
    public static final Workspace UNVERIFIED_USER_DEFAULT_WORKSPACE = Workspace.create("Default", ADMIN);
